...
```{r warning=FALSE, echo=FALSE, fig.cap= "Figure 2. Bacterial abundance at the phyla level in ruminal samples collected at the beginning and end of the feedlot period in Low-RFI steers"}
...
```{r warning=FALSE, echo=FALSE, fig.cap= "Figure 3. Bacterial abundance at the family level in ruminal samples collected at the beginning and end of the feedlot period in High-RFI steers"}

knitr::include_graphics("../../results/Highfamilycomb.png")

```

```{r warning=FALSE, echo=FALSE, fig.cap= "Figure 4. Bacterial abundance at the family level in ruminal samples collected at the beginning and end of the feedlot period in Low-RFI steers"}
...
```{r warning=FALSE, echo=FALSE, fig.cap= "Figure 5. Bacterial abundance at the genus level in ruminal samples collected at the beginning and end of the feedlot period in High-RFI steers"}

knitr::include_graphics("../../results/Highgenuscomb.png")

```

```{r warning=FALSE, echo=FALSE, fig.cap= "Figure 6. Bacterial abundance at the genus level in ruminal samples collected at the beginning and end of the feedlot period in Low-RFI steers"}
...
ANOVA allows us to see that there is variance between the bacterial abundance at beginning and end of the feedlot period in High-RFI steers (Table 5, Table 6). This indicates that the microbiome did experieience changes over the course of the feedlot period.



```{r linearMod.1table, echo=FALSE, warning=FALSE, fig.cap="Table 8. Linear Model in High RFI-steers, bacterial abundance verses time period."}
...
```{r linearMod.2table, echo=FALSE, warning=FALSE, fig.cap="Table 8. Linear Model in Low RFI-steers, bacterial abundance verses time period."}
...
## Full analysis: K- Means Cluster Analysis
...
#phylum
phyla.all <- readRDS(here("././results/phyla.all.rds"))
...
#family
family.all <- readRDS(here("././results/family.all.rds"))
...
#genera
genus.all <- readRDS(here("././results/genus.all.rds"))
...
```{r, all.km, echo=FALSE, warning=FALSE}
...
```{r, all.dist, echo=FALSE, warning=FALSE}

knitr::include_graphics("././results/all.dist.png")
plot(all.dist)
```

```{r, all.gap, echo=FALSE, warning=FALSE}
knitr::include_graphics("././results/all.gap.png")
plot(all.gap)
```

```{r, all.sil, echo=FALSE, warning=FALSE}
knitr::include_graphics("././results/all.sil.png")
plot(all.sil)
```

```{r, all.hier, echo=FALSE, warning=FALSE}
knitr::include_graphics("././results/all.hier.png")
plot(all.hier)

```

```{r, all.hsil, echo=FALSE, warning=FALSE}
knitr::include_graphics("././results/all.hsil.png")
plot(all.hsil)
```

```{r, all.hsp, echo=FALSE, warning=FALSE}
knitr::include_graphics("././results/all.hsp.png")
plot(all.hsp)
```
